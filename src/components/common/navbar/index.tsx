...
async function Navbar({ isAuthenticated }: Props) {
  ...
  return (
    <div className="flex w-full justify-between">
      ...
      <div className="flex gap-2 text-white justify-center items-center mr-10">
        {!isAuthenticated && (
          <Link
            href="/auth/login"
            className="hidden md:flex cursor-pointer mr-10 text-white underline-offset-4 hover:underline"
          >
